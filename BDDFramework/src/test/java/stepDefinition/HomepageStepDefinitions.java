...
public class HomepageStepDefinitions extends BaseClass{
	...
	@Then("I should see {int} options availble in search dropdown")
	public void i_should_see_options_availble_in_search_dropdown(int optionCount) {
	...
	@Then("I should see {string} option in the search dropdown")
	public void i_should_see_option_in_the_search_dropdown(String searchOption) {
		WebElement dropdown = browser.findElement(By.xpath(searchDropdownBox));
		List<WebElement> allOptions = dropdown.findElements(By.tagName("option"));
